  ...
  <div class="home">
    <v-toolbar class="mt-5" flat>
      ...
      <v-app-bar flat color="rgba(0,0,0,0)" class="ml-16">
        <v-tabs v-model="tab" color="purple" slider-size="5">
          <v-tab>
          ...
          <v-hover v-slot="{ hover }" open-delay="200">
            <v-card color="orange darken-1" :elevation="hover ? 16 : 2">
              <v-row>
                ...
                <v-col cols="12" sm="4">
                  <v-avatar size="100" class="ml-n10 mt-6" tile>
                    <v-img src="wallet.png"></v-img> </v-avatar
                ></v-col>
              </v-row>
            </v-card>
          </v-hover>
        ...
        <v-col cols="12" sm="6">
          <v-card>
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-spacer></v-spacer>
              <v-toolbar-title class="subtitle-1 black--text ml2">
                -0.00257 BTC
              </v-toolbar-title>
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-toolbar-title class="title black--text ml-2">
                Recieve litecoin<span class="caption"><br />Pending</span>
              </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-title class="subtitle-1 black--text ml2">
                -0.0133643 LTC
...
export default {
  ...
  data: () => ({
    ...
    padding: 8,
    radius: 10,
    value: [0, 2, 5, 10, 3, 0, 0, 1, 8, 2, 9, 0],
    width: 2,
    lineCap: "round",
    type: "trend",
    autoLineWidth: false,
